...
# the function (variables that are used locally but defined in an enclosing scope) with the value or reference to
# which the name was bound when the closure was created.
